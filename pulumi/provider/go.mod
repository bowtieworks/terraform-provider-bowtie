module github.com/bowtieworks/pulumi-bowtie/provider

go 1.22.0

replace github.com/bowtieworks/terraform-provider-bowtie => ../../

require (
	github.com/bowtieworks/terraform-provider-bowtie v0.0.0-00010101000000-000000000000
