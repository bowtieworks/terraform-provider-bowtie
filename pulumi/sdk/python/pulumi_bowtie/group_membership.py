...
class GroupMembershipArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] group_id: Internal resource ID.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] users: The list of users to grant membership to the group. This resource accepts both `user_ids` and emails. Will completely
...
class GroupMembership(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(GroupMembership, __self__).__init__(
            'bowtie:index/groupMembership:GroupMembership',
            resource_name,
            __props__,
            opts)
