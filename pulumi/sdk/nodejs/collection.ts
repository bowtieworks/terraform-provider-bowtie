...
export class Collection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bowtie:index/collection:Collection';
     ...
     */
    public readonly members!: pulumi.Output<outputs.CollectionMember[] | undefined>;
    /**
...
export interface CollectionState {
     ...
     * The locations contained in this collection.
     */
    members?: pulumi.Input<pulumi.Input<inputs.CollectionMember>[]>;
    /**
     * The human readable name of the collection.
     */
