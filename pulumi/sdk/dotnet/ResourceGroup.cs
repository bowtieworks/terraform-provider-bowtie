...
{
    [BowtieResourceType("bowtie:index/resourceGroup:ResourceGroup")]
    public partial class ResourceGroup : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("inheriteds")]
        public Output<ImmutableArray<string>> Inheriteds { get; private set; } = null!;
        ...
        public ResourceGroup(string name, ResourceGroupArgs args, CustomResourceOptions? options = null)
            : base("bowtie:index/resourceGroup:ResourceGroup", name, args ?? new ResourceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceGroup(string name, Input<string> id, ResourceGroupState? state = null, CustomResourceOptions? options = null)
            : base("bowtie:index/resourceGroup:ResourceGroup", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    {
        [Input("inheriteds", required: true)]
        private InputList<string>? _inheriteds;

        /// <summary>
        /// The list of resource groups to include in this resource group
        /// </summary>
        public InputList<string> Inheriteds
        {
            get => _inheriteds ?? (_inheriteds = new InputList<string>());
            set => _inheriteds = value;
        }
