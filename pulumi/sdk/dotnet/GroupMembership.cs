...
{
    [BowtieResourceType("bowtie:index/groupMembership:GroupMembership")]
    public partial class GroupMembership : global::Pulumi.CustomResource
    {
        ...
        /// <summary>
        /// The list of users to grant membership to the group. This resource accepts both `user_ids` and emails. Will completely
        ...
        public GroupMembership(string name, GroupMembershipArgs args, CustomResourceOptions? options = null)
            : base("bowtie:index/groupMembership:GroupMembership", name, args ?? new GroupMembershipArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GroupMembership(string name, Input<string> id, GroupMembershipState? state = null, CustomResourceOptions? options = null)
            : base("bowtie:index/groupMembership:GroupMembership", name, state, MakeResourceOptions(options, id))
        {
        }
