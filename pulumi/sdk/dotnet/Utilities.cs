...
namespace Pulumi.Bowtie
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Bowtie.version.txt");
    ...
    internal sealed class BowtieResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public BowtieResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
